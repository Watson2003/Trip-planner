...
export default function RoadTripMap({ route }: { route: RouteInfo }) {
  ...
  return (
    <section className="rounded-3xl border border-[#1a1a1a] bg-[#0a0a0a] p-4 shadow-glow backdrop-blur-xl">
      ...
      <div className="h-64 overflow-hidden rounded-3xl border border-[#1a1a1a] sm:h-80 md:h-96 lg:h-[500px]">
        <MapContainer center={center as [number, number]} zoom={5} scrollWheelZoom={false} className="h-full w-full">
          ...
          />
          <Polyline positions={route.polyline as [number, number][]} pathOptions={{ color: "#ffffff", weight: 4 }} />
