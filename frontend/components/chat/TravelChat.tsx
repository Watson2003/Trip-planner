  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      {open ? (
        <div className="mb-3 flex h-[70vh] w-[min(22rem,calc(100vw-2rem))] flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
          <div className="flex items-center justify-between gap-3 bg-slate-950 px-4 py-3 text-white">
            <div>
              <p className="text-xs uppercase tracking-[0.22em] text-slate-400">Travel Assistant</p>
      ...
      <button
        ...
        className="inline-flex items-center gap-2 rounded-full bg-slate-950 px-5 py-4 text-sm font-semibold text-white shadow-2xl transition hover:-translate-y-0.5 hover:bg-slate-800"
      >
